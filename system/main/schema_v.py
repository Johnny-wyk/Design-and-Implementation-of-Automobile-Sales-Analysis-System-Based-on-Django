...
from 汽车销量分析系统.settings import hasHadoop
from django.db import connection
from 汽车销量分析系统.views import check_suffix
import sys
...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        # cmd = "cd /yykj/python/9999/spider933733lu && scrapy crawl "+tableName+"Spider -a databaseName=djangod07x7d4j"
        # Windows
        cmd = "cd D:\\bishe\\汽车销量分析系统\\spider && D:\\PythonEnv\\Python\\Python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider -a databaseName=djangod07x7d4j"
        os.system(cmd)
