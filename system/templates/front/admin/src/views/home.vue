<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('xiaoshouinfo','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{xiaoshouinfoCount}}</div>
					<div class="name">销售信息总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="xiaoshouinfoChart1" class="echarts1 animate__animated" v-if="isAuth('xiaoshouinfo','首页统计')"></div>
			<div id="xiaoshouinfoChart2" class="echarts2 animate__animated" v-if="isAuth('xiaoshouinfo','首页统计')"></div>
			<div id="xiaoshouinfoChart3" class="echarts3 animate__animated" v-if="isAuth('xiaoshouinfo','首页统计')"></div>
			<div id="xiaoshouinfoChart4" class="echarts4 animate__animated" v-if="isAuth('xiaoshouinfo','首页统计')"></div>
			<div id="xiaoshouinfoChart5" class="echarts5 animate__animated" v-if="isAuth('xiaoshouinfo','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('xiaoshouinfo','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'xiaoshouinfoChart1',css:'animate__fadeInUp'},
				{id:'xiaoshouinfoChart2',css:'animate__fadeInUp'},
				{id:'xiaoshouinfoChart3',css:'animate__fadeInUp'},
				{id:'xiaoshouinfoChart4',css:'animate__fadeInUp'},
				{id:'xiaoshouinfoChart5',css:'animate__fadeInUp'},
			]
