<template>
	<div class="main-content" :style='{"padding":"20px 10px 20px 10px","fontSize":"15px"}'>
			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px 0 0","alignItems":"center","flexWrap":"wrap","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">厂商</label>
						<el-input v-model="searchForm.changshang" placeholder="厂商" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">车型</label>
						<el-input v-model="searchForm.chexing" placeholder="车型" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">最低售价（万元）</label>
						<el-input v-model="searchForm.minpricestart" placeholder="最小最低售价（万元）" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}' :label="'至'">
						<el-input v-model="searchForm.minpriceend" placeholder="最大最低售价（万元）" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">最高售价（万元）</label>
						<el-input v-model="searchForm.maxpricestart" placeholder="最小最高售价（万元）" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}' :label="'至'">
						<el-input v-model="searchForm.maxpriceend" placeholder="最大最高售价（万元）" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">时间</label>
						<el-input v-model="searchForm.tjtime" placeholder="时间" @keydown.enter.native="search()" clearable></el-input>
					</div>
				...
				<el-row class="actions" :style='{"padding":"10px","margin":"10px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
					<el-button class="add" v-if="isAuth('xiaoshouinfo','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia14" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"34px"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('xiaoshouinfo','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-shanchu6" :style='{"margin":"0 2px","fontSize":"14px","color":" #097499","height":"34px"}'></span>
						删除
					</el-button>


					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','爬取数据')" type="success" @click="spider()">
					...
					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','车型统计')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#097499","display":"none","height":"34px"}'></span>
						车型统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','最低售价统计')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#097499","display":"none","height":"34px"}'></span>
						最低售价统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','最高售价统计')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#097499","display":"none","height":"34px"}'></span>
						最高售价统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','月销量统计')" type="success" @click="chartDialog4()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#097499","display":"none","height":"34px"}'></span>
						月销量统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('xiaoshouinfo','当月销量排名')" type="success" @click="chartDialog5()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#097499","display":"none","height":"34px"}'></span>
						当月销量排名
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('xiaoshouinfo','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								查看
							</el-button>
							<el-button class="edit" v-if=" isAuth('xiaoshouinfo','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								修改
							</el-button>

							<el-button class="view" v-if="isAuth('xiaoshouinfo','查看评论')" type="success" @click="disscussListHandler(scope.row.id)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								查看评论
							</el-button>
							...
							<el-button class="del" v-if="isAuth('xiaoshouinfo','删除') " type="primary" @click="deleteHandler(scope.row.id )">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								删除
							</el-button>
						</template>
		...
		<el-dialog
			...
			width="800">
			<div id="chexingChart1" style="width:100%;height:600px;"></div>
		...
		<el-dialog
			...
			width="800">
			<div id="minpriceChart2" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="maxpriceChart3" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="mxiaoliangChart4" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="dyxlpmChart5" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
	...
	export default {
		...
		methods: {
			...
			chartDialog1() {
				...
				this.$nextTick(()=>{
					var chexingChart1 = echarts.init(document.getElementById("chexingChart1"),'macarons');
					this.$http({
						url: "xiaoshouinfo/group/chexing",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							var option = {};
							// 使用刚指定的配置项和数据显示图表。
							chexingChart1.setOption(option);
							  //根据窗口的大小变动图表
							window.onresize = function() {
								chexingChart1.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog2() {
				...
				this.$nextTick(()=>{
					...
					var minpriceChart2 = echarts.init(document.getElementById("minpriceChart2"),'macarons');
					this.$http({
						url: `xiaoshouinfo/value/chexing/minprice`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							minpriceChart2.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								minpriceChart2.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog3() {
				...
				this.$nextTick(()=>{
					...
					var maxpriceChart3 = echarts.init(document.getElementById("maxpriceChart3"),'macarons');
					this.$http({
						url: `xiaoshouinfo/value/chexing/maxprice`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							maxpriceChart3.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								maxpriceChart3.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog4() {
				...
				this.$nextTick(()=>{
					...
					var mxiaoliangChart4 = echarts.init(document.getElementById("mxiaoliangChart4"),'macarons');
					this.$http({
						url: `xiaoshouinfo/value/chexing/mxiaoliang`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							mxiaoliangChart4.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								mxiaoliangChart4.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog5() {
				...
				this.$nextTick(()=>{
					...
					var dyxlpmChart5 = echarts.init(document.getElementById("dyxlpmChart5"),'macarons');
					this.$http({
						url: `xiaoshouinfo/value/chexing/dyxlpm`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.minpricestart!='' && this.searchForm.minpricestart!=undefined ){
					params['minpricestart'] = this.searchForm.minpricestart
				}
				if(this.searchForm.minpriceend!='' && this.searchForm.minpriceend!=undefined){
					params['minpriceend'] = this.searchForm.minpriceend
				}
 				if(this.searchForm.maxpricestart!='' && this.searchForm.maxpricestart!=undefined ){
					params['maxpricestart'] = this.searchForm.maxpricestart
				}
				if(this.searchForm.maxpriceend!='' && this.searchForm.maxpriceend!=undefined){
					params['maxpriceend'] = this.searchForm.maxpriceend
				}
 				if(this.searchForm.tjtime!='' && this.searchForm.tjtime!=undefined){
					params['tjtime'] = '%' + this.searchForm.tjtime + '%'
				}
				params['sort'] = 'mxiaoliang';
				params['order'] = 'desc';
				let user = JSON.parse(this.$storage.getObj('userForm'))
				this.$http({
					url: "xiaoshouinfo/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
			...
			disscussListHandler(id,type) {
				this.$router.push({path:'/discussxiaoshouinfo',query:{refid:id}});
			},
			// 删除
